...
<main>
    <section class="main_info">
        <div class="main_header">
                ...
                <a class="btn btn-warning" onclick="location.href='assets/app/Benchmarkerv03.zip'" role="button" download>Atsisiųsti nemokamą programą</a>
        </div>
    </section>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card" style="width: 14rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text">Unikalūs kompiuteriai</p>
                        </div>
                    </div>
                </div>
            </div>
